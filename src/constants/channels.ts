...
/**
 * The full collection of 28 authorized YouTube channels.
...
export const CHANNELS: ReadonlyArray<Channel> = [
  ...
  { rank: 14, label: "スウェット", channelId: "UCCrxMkIxHHA89SWH1Od6g8Q" },
  { rank: 15, label: "まがいもの商事株式会社", channelId: "UCW-yyUvoFLBS28gR32a2Xmw" },
  { rank: 16, label: "オフボ屋🎸Dagger Hearts【ダガーハーツ】", channelId: "UCimDQtrwmDKPzgi5rRaAfCg" },
  { rank: 17, label: "HiroK Inst Channel", channelId: "UCojHiDbqtlYU089qIwKpJsw" },
  { rank: 18, label: "チャンネルぴー助", channelId: "UCK0NOAXbYo5-h6Sdu3RLBGQ" },
  { rank: 19, label: "SORA 初良 生演奏 カラオケ ちゃんねる", channelId: "UCMqgnW7zcdlZncFFoHowh2Q" },
  { rank: 20, label: "リミックス[音源配布中]", channelId: "UCvhmtvxxSP0F4iqWIfSnN6Q" },
  { rank: 21, label: "isBlank", channelId: "UCmK08xAeFLE3qgypIH4HHQw" },
  { rank: 22, label: "Yossy", channelId: "UCIuMN-FGE1B7OyKKxggJ2Dg" },
  { rank: 23, label: "Hiro’s Piano Arrangement", channelId: "UCWX2b3xIeJHoiNOPd9nTuKA" },
  { rank: 24, label: "ハイブリッジ", channelId: "UCR4L9Gl7hkHw44gZR5vLn4Q" },
  { rank: 25, label: "星海ハル", channelId: "UCpHRdO77UDchUGe5XkDnyrA" },
  { rank: 26, label: "HoneyWorks 2nd Channel", channelId: "UCfuBLr03CN1OWKP0XS5GqFA" },
  { rank: 27, label: "(^^)・・・つ", channelId: "UCv6cA8lChl-z3OC_RcqsduQ" },
  { rank: 28, label: "negoto@ ฅ۶•ﻌ•♡ฅ", channelId: "UC3EXlgN50es9dP_6GxC84aQ" },
];
